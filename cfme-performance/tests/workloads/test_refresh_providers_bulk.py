...
from utils.workloads import get_refresh_providers_bulk_scenarios
import time
import pytest


@pytest.mark.parametrize('scenario', get_refresh_providers_bulk_scenarios())
def test_refresh_providers_bulk(request, scenario):
    ...
    monitor_thread = SmemMemoryMonitor(SSHClient(), 'workload-refresh-providers-bulk', scenario['name'],
        'refresh-providers-bulk', get_server_roles_workload_refresh_providers(separator=','),
